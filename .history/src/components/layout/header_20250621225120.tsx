...
export default function Header() {
  ...
  return (
    <div>
      <>
        <header className="fixed w-full top-0 z-50 bg-gradient-to-r from-gray-900 via-blue-900 to-gray-900 dark:from-black dark:via-gray-900 dark:to-black backdrop-blur-md border-b border-blue-500/20 dark:border-blue-400/30 shadow-2xl">
