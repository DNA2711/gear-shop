...
export default function Header() {
  ...
  const SearchSuggestionsDropdown = ({ isMobile = false }) => (
    <>
      {showSuggestions && (
        <div className={`absolute top-full left-0 right-0 mt-2 bg-white/95 glass-effect rounded-2xl shadow-2xl border border-gray-200/50 overflow-hidden z-50 max-h-[500px] overflow-y-auto animate-in search-dropdown ${isMobile ? 'mx-4' : ''}`}>
            ...
            <div className="md:hidden border-t border-white/10 pb-4">
              <div className="py-4 space-y-3">
                ...
                <div className="border-t border-white/10 pt-3 mt-3">
                  <div className="px-4 text-sm text-gray-400 mb-2">Danh mục phổ biến</div>
