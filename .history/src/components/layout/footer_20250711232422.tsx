        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-10 mb-8 sm:mb-12">
          <div className="space-y-4 sm:space-y-6 text-center sm:text-left">
            <div className="flex items-center justify-center sm:justify-start space-x-3">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-white">GearHub</h3>
            </div>
            ...
            <div className="space-y-2 sm:space-y-3">
              <div className="flex items-center justify-center sm:justify-start space-x-3 text-gray-300 text-sm sm:text-base">
                ...
                <span className="text-center sm:text-left">175 Tây Sơn Phường Kim Liên, TP.Hà Nội</span>
              </div>
              ...
              <div className="flex items-center justify-center sm:justify-start space-x-3 text-gray-300 text-sm sm:text-base">
                ...
                <span className="text-center sm:text-left">8:00 - 22:00 (Thứ 2 - Chủ nhật)</span>
              </div>
            </div>
          </div>

          <div className="space-y-4 sm:space-y-6 text-center sm:text-left">
            <h4 className="text-lg sm:text-xl font-bold text-white">Liên kết nhanh</h4>
          ...
          <div className="space-y-4 sm:space-y-6 text-center sm:text-left">
            <h4 className="text-lg sm:text-xl font-bold text-white">Hỗ trợ khách hàng</h4>
            <div className="grid grid-cols-2 sm:grid-cols-1 gap-2 sm:gap-3">
              <LoadingLink
                href="/profile"
                loadingMessage="Đang tải hồ sơ..."
          ...
          <div className="space-y-4 sm:space-y-6 text-center sm:text-left">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="flex items-center justify-center sm:justify-start space-x-3">
                ...
                <span className="text-gray-300 text-sm sm:text-base">Hỗ trợ 24/7</span>
              </div>
            </div>
          ...
          <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-800/50">
            <div className="text-center">
              <p className="text-gray-500 text-xs sm:text-sm leading-relaxed">
                ...
                Cung cấp thiết bị công nghệ chất lượng cao cho game thủ và chuyên gia IT tại Việt Nam
              </p>
