            ...
            <div className="p-6">
              <div className="grid grid-cols-2 gap-4">
                {[...Array(8)].map((_, i) => (
                  <div
                    key={i}
                    className="h-32 p-4 rounded-xl bg-gray-800/50 border border-gray-700/50 flex flex-col"
                  >
              ...
              <div className="grid grid-cols-2 gap-2 p-4">
                {categories.map((category, index) => (
                  ...
                  >
                    ...
                    >
                      <div className="h-32 p-4 rounded-xl bg-gray-800/50 hover:bg-gray-700/70 transition-all duration-300 group-hover:scale-[1.02] group-hover:shadow-lg border border-gray-700/50 group-hover:border-gray-600/50 flex flex-col">
                        <div className="flex items-center gap-3 mb-3">
                          <div
                              ...
                              <div className="space-y-1">
                                {category.children.slice(0, 1).map((child) => (
                                  <div
                                    ...
                                    className="flex items-center gap-2 text-xs text-gray-400 hover:text-blue-400 transition-colors p-1 rounded cursor-pointer"
                                    onClick={(e) => {
                                      e.preventDefault();
                                      e.stopPropagation();
                                  ...
                                  >
                                    <div className="w-1.5 h-1.5 bg-blue-400/60 rounded-full flex-shrink-0"></div>
                                ...
                                {category.children.length > 1 && (
                                  <div className="text-xs text-blue-400 font-medium flex items-center gap-1 p-1">
                          ...
                          <div className="grid grid-cols-1 gap-1">
                            {category.children.map((child) => (
                              ...
                              >
                                ...
                                <span className="leading-relaxed break-words">{child.category_name}</span>
                              </div>
                            ))}
                          </div>
                        </div>
