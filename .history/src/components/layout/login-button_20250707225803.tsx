  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          className="text-blue-400 hover:bg-blue-400/10 hover:text-blue-300 transition-all duration-200 flex items-center space-x-2"
        >
          <UserAvatar user={user || undefined} size="sm" showStatus />
          <span className="hidden sm:inline text-white hover:text-blue-300">
