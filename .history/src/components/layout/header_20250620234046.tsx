          ...
          <div className="container flex items-center justify-between gap-5 h-24 relative">
            ...
            <div className="hidden lg:flex items-center gap-3 text-white">
              ...
              <Button
                variant="ghost"
                size="sm"
                className="flex items-center gap-2 text-white hover:text-red-400 hover:bg-white/10 transition-all duration-200 rounded-full px-3 py-2"
              >
                <Heart className="w-4 h-4" />
                <span className="hidden xl:inline text-white hover:text-red-400">
                  Yêu thích
                </span>
              </Button>
              <Button
                variant="ghost"
                size="sm"
                className="flex items-center gap-2 text-white hover:text-yellow-400 hover:bg-white/10 transition-all duration-200 rounded-full px-3 py-2"
              >
                <Bell className="w-4 h-4" />
                <span className="hidden xl:inline text-white hover:text-yellow-400">
                  Thông báo
                </span>
              </Button>
              <Button
                variant="ghost"
                size="sm"
                className="flex items-center gap-2 text-white hover:text-green-400 hover:bg-white/10 transition-all duration-200 rounded-full px-3 py-2"
              >
                <User className="w-4 h-4" />
                <span className="hidden xl:inline text-white hover:text-green-400">
                  Tài khoản
                </span>
              </Button>
            </div>
