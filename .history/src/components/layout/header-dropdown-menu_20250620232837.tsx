...
export default function HeaderDropdownMenu() {
  ...
  const getCategoryIcon = (categoryCode: string) => {
    const iconMap: { [key: string]: JSX.Element } = {
      ...
      mainboard: <Motherboard className="w-5 h-5" />,
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent 
        className="w-[900px] bg-gray-900/95 backdrop-blur-xl border-gray-700/50 text-white shadow-2xl max-h-[80vh] overflow-hidden"
        align="start"
        sideOffset={8}
      >
              ...
              <div className="grid grid-cols-2 gap-2 p-4">
                {categories.map((category, index) => (
                  ...
                  >
                    ...
                    >
                      <div className="p-4 rounded-xl bg-gray-800/50 hover:bg-gray-700/70 transition-all duration-300 group-hover:scale-[1.02] group-hover:shadow-lg border border-gray-700/50 group-hover:border-gray-600/50">
                        <div className="flex items-center gap-3 mb-3">
                          <div className={`p-2 rounded-lg bg-gradient-to-br ${getCategoryGradient(index)} shadow-lg`}>
                          ...
                          <div className="space-y-1">
                            {category.children.slice(0, 3).map((child) => (
                              ...
                              >
                                ...
                                <span className="truncate">{child.category_name}</span>
                              </div>
                            ))}
                    ...
                    {hoveredCategory === category.category_id && category.children && category.children.length > 3 && (
              ...
              <div className="border-t border-gray-700/50 bg-gray-800/30 p-4">
                <div className="flex items-center justify-between">
                  <div className="text-sm text-gray-400">
                    <span className="text-blue-400 font-medium">Nổi bật:</span> Gaming PC, RTX 40 Series, AMD Ryzen 7000
                  </div>
                  <LoadingLink
                    href="/products"
