          ...
          <div className="container flex items-center justify-between gap-5 h-24 relative">
            ...
            <div className="hidden lg:flex items-center gap-3 text-white">
              ...
              <div className="relative group">
                <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-red-500/10 to-pink-500/10 border border-red-500/20 hover:border-red-400/40 transition-all duration-300 hover:shadow-lg hover:shadow-red-500/25 hover:scale-105 cursor-pointer">
                  <Heart className="w-4 h-4 text-red-400 group-hover:text-red-300 transition-colors" />
                  <span className="hidden xl:inline text-sm font-medium text-white group-hover:text-red-300 transition-colors">
                    Yêu thích
                  </span>
              ...
              <div className="relative group">
                <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-yellow-500/10 to-orange-500/10 border border-yellow-500/20 hover:border-yellow-400/40 transition-all duration-300 hover:shadow-lg hover:shadow-yellow-500/25 hover:scale-105 cursor-pointer">
                  <Bell className="w-4 h-4 text-yellow-400 group-hover:text-yellow-300 transition-colors" />
                  <span className="hidden xl:inline text-sm font-medium text-white group-hover:text-yellow-300 transition-colors">
                    Thông báo
                  </span>
                  <div className="absolute inset-0 bg-gradient-to-r from-yellow-500/0 to-orange-500/0 group-hover:from-yellow-500/5 group-hover:to-orange-500/5 rounded-xl transition-all duration-300"></div>
                </div>
              </div>
