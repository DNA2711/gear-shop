    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-64 bg-gray-900 border-gray-700 text-white shadow-2xl">
        ...
        <DropdownMenuItem className="hover:bg-gray-800 cursor-pointer py-2">
          ...
          <Link href="/profile" className="flex-1">Hồ sơ cá nhân</Link>
        </DropdownMenuItem>

        <DropdownMenuItem className="hover:bg-gray-800 cursor-pointer py-2">
          <ShoppingBag className="w-4 h-4 mr-3 text-green-400" />
          <Link href="/orders" className="flex-1">Đơn hàng của tôi</Link>
        </DropdownMenuItem>

        <DropdownMenuItem className="hover:bg-gray-800 cursor-pointer py-2">
          <Heart className="w-4 h-4 mr-3 text-pink-400" />
          <Link href="/wishlist" className="flex-1">Danh sách yêu thích</Link>
        </DropdownMenuItem>

        <DropdownMenuItem className="hover:bg-gray-800 cursor-pointer py-2">
          <Settings className="w-4 h-4 mr-3 text-gray-400" />
          <Link href="/settings" className="flex-1">Cài đặt</Link>
        </DropdownMenuItem>
