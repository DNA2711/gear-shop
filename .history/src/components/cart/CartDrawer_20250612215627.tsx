...
export default function CartDrawer({ isOpen, onClose }: CartDrawerProps) {
  ...
  return (
    <>
      {/* Backdrop */}
      <div
        className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm z-[60] transition-opacity duration-300"
        onClick={onClose}
      />

      {/* Drawer */}
      <div className="fixed top-0 right-0 h-full w-full max-w-md bg-white shadow-2xl z-[70] transform transition-transform translate-x-0 duration-300 ease-in-out border-l border-gray-200">
        {/* Header */}
