  ...
  return (
    ...
    return (
      <>
        ...
        <div className="fixed top-0 right-0 h-full w-full max-w-md bg-white shadow-2xl z-50 flex items-center justify-center">
          <div className="text-center p-8">
            <p className="text-red-500 mb-4">Có lỗi xảy ra với giỏ hàng</p>
            <button 
              onClick={onClose}
