...
export default function AddToCartButton({ 
  ...
  if (stockQuantity === 0) {
    return (
      <div className={`flex items-center justify-center py-2 px-4 bg-gray-200 text-gray-500 rounded-lg ${className}`}>
        Hết hàng
      </div>
    );
  }
  ...
  if (maxAvailable === 0) {
    return (
      <div className={`flex items-center justify-center py-2 px-4 bg-yellow-100 text-yellow-700 rounded-lg ${className}`}>
