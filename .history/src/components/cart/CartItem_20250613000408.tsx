    ...
    <div className="flex items-center gap-4 p-4 border border-gray-200 rounded-lg">
        ...
        {item.primary_image ? (
          <img
            ...
            onError={(e) => {
              ...
              if (parent) {
                parent.innerHTML = '<div class="w-full h-full flex items-center justify-center text-gray-400"><span class="text-xs text-center">Lỗi ảnh</span></div>';
              }
            }}
          />
        ) : (
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-2 mt-1">
          <span className="text-sm text-gray-500">Mã: {item.product_code}</span>
          {item.brand_name && (
            <>
