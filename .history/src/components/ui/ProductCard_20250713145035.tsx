        ...
        >
          <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-gray-200/50 overflow-hidden h-full flex flex-col transition-all duration-300 group-hover:shadow-2xl group-hover:shadow-orange-500/20">
            ...
            <div className="p-2 sm:p-3 flex flex-col flex-grow">
              ...
              <h3 className="font-medium text-xs sm:text-sm text-gray-900 mb-2 line-clamp-2 hover:text-orange-600 transition-colors leading-tight min-h-[2rem] sm:min-h-[2.5rem] group-hover:text-orange-600">
              ...
              <div className="mb-2 sm:mb-3 mt-auto">
                ...
                <div className="text-sm sm:text-lg font-bold bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent">
              ...
              <div className="flex items-center justify-between">
                ...
                {!isAuthenticated ? (
                  <a
                    href="/login"
                    className="rounded-full p-2 transition-all duration-200 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white shadow-lg hover:scale-110"
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-300 h-full flex flex-col">
      <LoadingLink
        ...
        loadingMessage="Đang tải chi tiết sản phẩm..."
      >
        <div className="relative aspect-[4/3] bg-gray-50 p-1 sm:p-2">
          {product.primary_image ? (
            <Image
              src={
                product.primary_image.startsWith("data:")
      ...
      <div className="p-2 sm:p-3 flex flex-col flex-grow">
        ...
        <p className="text-xs text-gray-500 mb-1">
          ...
          <span className="sm:hidden">
            {product.product_code.length > 10
              ? product.product_code.substring(0, 10) + "..."
        ...
        <LoadingLink
          ...
          loadingMessage="Đang tải chi tiết sản phẩm..."
        >
          <h3 className="font-medium text-xs sm:text-sm text-gray-900 mb-2 line-clamp-2 hover:text-blue-600 transition-colors leading-tight min-h-[2rem] sm:min-h-[2.5rem]">
            {product.product_name}
          </h3>
        </LoadingLink>
        ...
        <div className="mb-2 mt-auto">
          ...
          <div className="text-sm sm:text-lg font-bold text-gray-900 price-text">
            {formatPrice(product.price)}
          </div>
        </div>
        ...
        <div className="flex items-center justify-between mt-auto">
          ...
          {!isAuthenticated ? (
            <a
              href="/login"
              className="rounded-full p-1 sm:p-1.5 transition-colors duration-200 bg-blue-500 hover:bg-blue-600 text-white"
              title="Đăng nhập để mua hàng"
            >
            ...
            <button
              className={`rounded-full p-1 sm:p-1.5 transition-colors duration-200 ${
                product.stock_quantity && product.stock_quantity > 0
