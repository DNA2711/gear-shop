...
import { Cpu, HardDrive, Monitor, Keyboard, Zap, Gamepad2, ArrowRight, Star } from "lucide-react";
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <div className="text-right">
                        <div className="text-sm opacity-80 font-medium">Sản phẩm</div>
        ...
        <div className="mt-20">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 bg-slate-800/30 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50">
            ...
            <div className="text-center group">
              ...
              <div className="text-slate-300 font-medium">Đánh giá khách hàng</div>
            </div>
          </div>
        </div>
      </div>
