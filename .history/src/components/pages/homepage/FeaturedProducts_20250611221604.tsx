...
export default function FeaturedProducts() {
  ...
  const getProductImage = (product: ProductWithDetails) => {
    return product.primary_image || "https://images.unsplash.com/photo-1591488320449-011701bb6704?w=400&h=300&fit=crop";
  };
    ...
    <section className="py-20 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 relative overflow-hidden scroll-section">
      ...
      <div className="container mx-auto px-4 relative z-10">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-4 lg:p-5 xl:p-4 2xl:p-4">
                      ...
                      <div className="text-slate-300 text-sm lg:text-base xl:text-sm 2xl:text-sm font-semibold mb-1 line-clamp-2">
                        {product.product_name}
                      </div>
                      <div className="text-slate-400 text-xs lg:text-sm xl:text-xs 2xl:text-xs mb-2">
                        {product.brand_name || 'No Brand'} • {product.category_name || 'Uncategorized'}
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-blue-400 font-semibold text-sm lg:text-base xl:text-sm 2xl:text-sm">
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center bg-slate-800/20 backdrop-blur-sm rounded-xl p-6 border border-slate-700/30">
            <div className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent mb-2">
              1000+
            </div>
            <div className="text-slate-300">Sản phẩm chất lượng</div>
          </div>
          ...
          <div className="text-center bg-slate-800/20 backdrop-blur-sm rounded-xl p-6 border border-slate-700/30">
            ...
            <div className="text-slate-300">Khách hàng hài lòng</div>
          </div>
        </div>
      </div>
    </section>
