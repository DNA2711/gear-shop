              ...
              <div key={deal.id} className="bg-white rounded-xl shadow-lg overflow-hidden border-2 border-red-200">
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="md:w-1/2 p-6">
                    ...
                    <h3 className="text-xl font-bold text-gray-800 mb-3">{deal.name}</h3>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex space-x-2">
                        ...
                        <div className="bg-red-500 text-white px-3 py-2 rounded text-center">
                          <div className="text-lg font-bold">{time.minutes}</div>
                          <div className="text-xs">Phút</div>
                        </div>
                        <div className="bg-red-500 text-white px-3 py-2 rounded text-center">
                          <div className="text-lg font-bold">{time.seconds}</div>
