          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white mb-2">Tin tức công nghệ nóng hổi</h3>
                  <p className="text-slate-300 text-sm">Cập nhật những xu hướng mới nhất về gaming hardware, AI và công nghệ.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white mb-2">Ưu đãi độc quyền</h3>
                  <p className="text-slate-300 text-sm">Giảm giá đặc biệt, flash sale và voucher chỉ dành cho thành viên newsletter.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white mb-2">Review chuyên sâu</h3>
                  <p className="text-slate-300 text-sm">Đánh giá chi tiết từ team chuyên gia về CPU, GPU và gaming gear.</p>
                </div>
              </div>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 border border-purple-500/20 shadow-2xl">
              <div className="text-center mb-6">
                ...
                <p className="text-slate-300 text-sm">Miễn phí 100% - Hủy đăng ký bất cứ lúc nào</p>
              </div>
