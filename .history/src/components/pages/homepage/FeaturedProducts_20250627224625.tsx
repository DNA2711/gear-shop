      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-300 text-xl lg:text-2xl max-w-3xl mx-auto leading-relaxed mb-8">
            Những linh kiện máy tính <span className="text-orange-400 font-semibold">được săn đón nhiều nhất</span> với 
            <span className="text-red-400 font-semibold"> công nghệ tiên tiến</span> và 
            <span className="text-yellow-400 font-semibold"> giá cả hấp dẫn</span>
          </p>
          ...
          <div className="bg-gradient-to-r from-slate-800/50 to-slate-700/50 backdrop-blur-sm rounded-3xl p-8 border border-slate-600/50 max-w-2xl mx-auto">
            <div className="mb-6">
              ...
              <p className="text-slate-300 text-lg">
                Hơn <span className="text-orange-400 font-semibold">1000+ sản phẩm</span> đang chờ bạn khám phá
              </p>
            </div>
