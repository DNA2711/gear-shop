                ...
                <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden border border-red-500/20 hover:border-red-500/50 transition-all duration-500 hover:scale-105">
                  ...
                  <div className="flex flex-col lg:flex-row">
                    ...
                    <div className="relative h-48 lg:h-56 xl:h-44 2xl:h-40 overflow-hidden">
                      ...
                      {/* Flash Sale Badge */}
                      <div className="absolute top-3 left-3 bg-gradient-to-r from-red-500 via-orange-500 to-yellow-500 text-white px-3 py-1.5 rounded-full text-xs font-bold flex items-center gap-1.5 animate-pulse">
                        <Zap className="w-3 h-3" />
                        FLASH SALE
                      </div>

                      {/* Trending Badge */}
                      <div className="absolute top-3 right-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white px-2 py-1 rounded-lg text-xs font-bold flex items-center gap-1">
                      ...
                      <div className="absolute bottom-3 left-3 right-3">
                        <div className="bg-slate-800/60 backdrop-blur-sm rounded-full p-1">
                          <div className="flex justify-between text-xs text-white mb-1 px-2">
                            <span>Đã bán: {deal.sold}</span>
                            <span>Còn lại: {deal.stock}</span>
                          </div>
