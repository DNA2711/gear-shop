        ...
        <div className="mt-12 sm:mt-16 lg:mt-20">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 bg-slate-800/30 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border border-slate-700/50">
            <div className="text-center group">
              ...
              <div className="text-slate-300 font-medium text-xs sm:text-sm lg:text-base">Sản phẩm có sẵn</div>
            </div>
            ...
            <div className="text-center group">
              ...
              <div className="text-slate-300 font-medium text-xs sm:text-sm lg:text-base">Hỗ trợ kỹ thuật</div>
            </div>
            ...
            <div className="text-center group">
              ...
              <div className="text-slate-300 font-medium text-xs sm:text-sm lg:text-base">Vận chuyển nhanh</div>
            </div>
