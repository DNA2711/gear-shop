    ...
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 sm:py-12 lg:py-20 max-w-7xl">
        ...
        <div className="mt-12 sm:mt-16 lg:mt-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4 sm:gap-6 max-w-6xl mx-auto">
            {hotProducts.map((product, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group relative bg-black/40 backdrop-blur-sm border border-blue-500/20 rounded-xl p-4 lg:p-6 hover:border-blue-400/40 transition-all duration-300 hover:scale-105"
                >
                  {product.hot && (
