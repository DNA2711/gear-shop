...
const ProductCardSkeleton = () => (
  <div className="group h-full">
    <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-gray-200/50 overflow-hidden h-full flex flex-col animate-pulse">
      ...
      <div className="p-3 flex flex-col flex-grow space-y-3">
        ...
        <div className="mt-auto space-y-2">
          <div className="h-3 bg-gray-300 rounded w-1/2"></div>
          <div className="h-6 bg-gradient-to-r from-gray-300 to-gray-400 rounded w-2/3"></div>
        </div>
...
export default function FeaturedProducts() {
  ...
  if (error) {
    return (
      <section className="py-20 relative overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 scroll-section">
        {/* Animated Background */}
  ...
  return (
    <section className="py-20 relative overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 scroll-section">
      {/* Top Separator - Natural Gradient */}
      <div className="absolute top-0 left-0 w-full h-8 bg-gradient-to-b from-blue-500/10 via-blue-400/5 to-transparent"></div>
      ...
      {/* Bottom Separator - Natural Gradient */}
      <div className="absolute bottom-0 left-0 w-full h-8 bg-gradient-to-t from-blue-500/10 via-blue-400/5 to-transparent"></div>
    </section>
  );
}
