        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl mx-auto text-center">
            <div className="mb-8">
              ...
              <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent mb-6">
                Đăng ký thành công! 🎉
              </h2>
              
              <p className="text-slate-300 text-xl leading-relaxed">
                Cảm ơn bạn đã đăng ký! Chúng tôi sẽ gửi những tin tức công nghệ mới nhất và ưu đãi độc quyền đến email của bạn.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-slate-800/30 backdrop-blur-sm rounded-xl p-6 border border-green-500/20">
                ...
                <p className="text-slate-300 text-sm">Giảm giá lên đến 30% cho thành viên</p>
              </div>
              
              <div className="bg-slate-800/30 backdrop-blur-sm rounded-xl p-6 border border-green-500/20">
                <Bell className="w-8 h-8 text-green-400 mx-auto mb-3" />
                <h3 className="text-white font-semibold mb-2">Tin tức sớm nhất</h3>
                <p className="text-slate-300 text-sm">Cập nhật sản phẩm mới trước ai hết</p>
              </div>
              
              <div className="bg-slate-800/30 backdrop-blur-sm rounded-xl p-6 border border-green-500/20">
                <Star className="w-8 h-8 text-green-400 mx-auto mb-3" />
                <h3 className="text-white font-semibold mb-2">Review chuyên sâu</h3>
                <p className="text-slate-300 text-sm">Đánh giá chi tiết từ chuyên gia</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-slate-300 text-xl max-w-2xl mx-auto leading-relaxed">
              Nhận thông tin mới nhất về công nghệ, ưu đãi độc quyền và review chi tiết
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">Tin tức công nghệ nóng hổi</h3>
                  <p className="text-slate-300">Cập nhật những xu hướng mới nhất về gaming hardware, AI và công nghệ.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">Ưu đãi độc quyền</h3>
                  <p className="text-slate-300">Giảm giá đặc biệt, flash sale và voucher chỉ dành cho thành viên newsletter.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">Review chuyên sâu</h3>
                  <p className="text-slate-300">Đánh giá chi tiết từ team chuyên gia về CPU, GPU và gaming gear.</p>
                </div>
              </div>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-purple-500/20 shadow-2xl">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">Tham gia cộng đồng</h3>
                <p className="text-slate-300">Miễn phí 100% - Hủy đăng ký bất cứ lúc nào</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      className="w-full px-4 py-4 bg-slate-700/50 border border-slate-600 rounded-xl text-white placeholder-slate-400 focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300"
                    />
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white py-4 rounded-xl font-semibold text-lg transition-all duration-300 hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                >
                  {isLoading ? (
              ...
              <div className="mt-8 pt-6 border-t border-slate-700">
                ...
                <p className="text-sm text-slate-300 text-center">
                  "Newsletter tốt nhất về công nghệ mà tôi từng đăng ký!" - <span className="text-purple-400">Tech Pro</span>
                </p>
              </div>
            </div>
          </div>
