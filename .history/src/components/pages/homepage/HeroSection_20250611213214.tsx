...
export default function HeroSection() {
  ...
  const heroSlides = [
    {
      ...
      description: "Linh kiện gaming chính hãng, hiệu năng cao cho mọi game thủ",
      image: "https://images.unsplash.com/photo-1592840496694-26d035b52b48?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
      badge: "HOT 2024",
  ...
  return (
      ...
      <div className="relative z-10 container mx-auto px-4 pt-32 pb-20">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className={`lg:w-1/2 space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            {/* Hero Badge */}
            <div className={`inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r ${currentHero.color} rounded-full text-white font-semibold text-sm shadow-lg`}>
            ...
            <div className="grid grid-cols-2 gap-4 pt-8">
              {features.map((feature, index) => (
                <div key={index} className="flex items-center gap-3 p-4 bg-gray-800/30 rounded-lg backdrop-blur-sm border border-gray-700/50">
    ...
    <section className="relative bg-gradient-to-r from-blue-600 to-purple-700 text-white pt-32 pb-20">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between">
          <div className="lg:w-1/2 space-y-6">
            ...
            <p className="text-xl text-gray-200">
              Cung cấp các linh kiện điện tử, Arduino, Raspberry Pi, sensors và
              nhiều hơn nữa với giá tốt nhất
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
