      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-300 text-xl max-w-2xl mx-auto leading-relaxed">
            Khám phá những linh kiện máy tính hàng đầu với công nghệ tiên tiến nhất
          </p>
          ...
          {loading
            ...
            : products.map((product) => (
                <div key={product.product_id} className="group">
                  <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl border border-slate-700/50 overflow-hidden hover:border-blue-500/50 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/20">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center bg-slate-800/30 backdrop-blur-sm rounded-xl p-6 border border-slate-700/50">
            <div className="text-3xl font-bold text-cyan-400 mb-2">Miễn phí</div>
