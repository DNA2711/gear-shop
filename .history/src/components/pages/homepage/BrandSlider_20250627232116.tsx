    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="relative">
          {/* Brand Grid */}
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-1 md:gap-2 lg:gap-4">
            {visibleBrands.map((brand, index) => (
              ...
              >
                {/* Brand Card */}
                <div className="relative bg-gradient-to-br from-white/95 to-gray-100/95 backdrop-blur-sm p-4 md:p-6 lg:p-8 rounded-2xl border border-gray-300/50 group-hover:border-blue-400/50 transition-all duration-500 group-hover:transform group-hover:scale-105 h-28 md:h-32 flex items-center justify-center shadow-lg hover:shadow-xl hover:shadow-blue-500/20">
                  {/* Shine Effect */}
                  ...
                  {/* Corner Accent */}
                  <div className="absolute top-2 right-2 w-2 h-2 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </div>
              </div>
            ))}
          </div>
          ...
          {brands.length > 6 && (
            <div className="flex justify-center space-x-2 mt-12">
              <button
                onClick={prevSlide}
                className="w-10 h-10 bg-blue-600/20 hover:bg-blue-600/40 rounded-full flex items-center justify-center transition-all duration-300"
              >
