                ...
                <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden border border-red-500/20 hover:border-red-500/50 transition-all duration-500 hover:scale-105">
                  ...
                  <div className="flex flex-col lg:flex-row">
                    ...
                    <div className="lg:w-1/2 p-6 lg:p-8 flex flex-col justify-between">
                      {/* Product Info */}
                      <div>
                        <h3 className="text-xl lg:text-2xl font-bold text-white mb-4 leading-tight group-hover:text-red-400 transition-colors duration-300">
                          {deal.name}
                        </h3>
                      ...
                      <div className="mb-6">
                        ...
                        <div className="flex space-x-2">
                          ...
                          <div className="bg-gradient-to-br from-orange-500 to-orange-600 text-white px-3 py-2 rounded-xl text-center shadow-lg min-w-[50px]">
                            <div className="text-lg font-bold">
                          <div className="bg-gradient-to-br from-orange-500 to-orange-600 text-white px-4 py-3 rounded-xl text-center shadow-lg min-w-[60px]">
                            <div className="text-xl font-bold">
                              {time.minutes}
                            </div>
                            <div className="text-xs opacity-80">Phút</div>
                          </div>
                          <div className="bg-gradient-to-br from-yellow-500 to-yellow-600 text-white px-4 py-3 rounded-xl text-center shadow-lg min-w-[60px]">
                            <div className="text-xl font-bold">
                              {time.seconds}
                            </div>
                      ...
                      {/* Action Button */}
                      <button className="w-full bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 text-white py-4 rounded-xl font-bold text-lg transition-all duration-300 hover:scale-105 hover:shadow-xl shadow-lg">
        ...
        <div className="text-center mt-16">
          <div className="bg-slate-800/30 backdrop-blur-sm rounded-2xl p-8 border border-red-500/20">
            ...
            <h3 className="text-2xl font-bold text-white mb-2">
              Flash Sale chỉ diễn ra hôm nay!
            </h3>
            <p className="text-slate-300 mb-6">
              Đừng bỏ lỡ cơ hội sở hữu linh kiện gaming với giá không thể tốt
              hơn
            </p>
