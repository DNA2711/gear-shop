    ...
    <section className="py-12 relative overflow-hidden scroll-section">
      ...
      <div className="container mx-auto px-4 relative z-10 max-w-7xl">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-4 py-2 rounded-full text-xs sm:text-sm font-semibold mb-4 shadow-lg backdrop-blur-sm">
            <BookOpen className="w-3 h-3 sm:w-4 sm:h-4 mr-2" />
            TECH NEWS & REVIEWS
          </div>

          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-blue-400 via-cyan-400 to-purple-400 bg-clip-text text-transparent mb-4 leading-tight">
            Tin Tức & Đánh Giá
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 max-w-6xl mx-auto">
          {techNews.map((item, index) => (
            <article
              key={item.id}
              className="group relative bg-slate-800/50 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-2xl overflow-hidden border border-slate-700/50 hover:border-blue-500/50 transition-all duration-500 hover:scale-105"
            ...
            >
              ...
              <div className="relative overflow-hidden">
                <img
                  src={item.image}
                  alt={item.title}
                  className="w-full h-36 sm:h-40 object-cover object-center group-hover:scale-110 transition-transform duration-700"
                />
