...
const newsItems: NewsItem[] = [
  {
    ...
    excerpt: "Học cách kết nối ESP32 với Arduino Cloud để tạo ra một hệ thống IoT hoàn chỉnh, giám sát nhiệt độ và độ ẩm từ xa.",
  ...
  },
  {
    ...
    excerpt: "Khám phá những cải tiến mới nhất trên Raspberry Pi 5 với hiệu năng được nâng cấp đáng kể và các tính năng mới.",
    image: "/api/placeholder/400/250",
    date: "2024-01-12",
    category: "News",
    readTime: 5
  },
  {
    ...
    excerpt: "Hướng dẫn chi tiết cách tạo robot có thể tự động tránh vật cản sử dụng Arduino Uno và cảm biến HC-SR04.",
    image: "/api/placeholder/400/250",
    date: "2024-01-10",
    category: "Project",
    readTime: 12
    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {newsItems.map((item) => (
            <article key={item.id} className="bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden">
