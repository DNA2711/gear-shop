...
export default function HeroSection() {
  ...
  const heroSlides = [
    {
      ...
      description: "Card đồ họa mạnh nhất thế giới với hiệu năng 4K Ultra Gaming đỉnh cao",
    ...
    },
    {
      ...
      description: "Bộ vi xử lý flagship mới nhất với hiệu suất vượt trội và hiệu năng năng lượng tối ưu",
    ...
    },
    {
      ...
      description: "Case gaming cao cấp nhất 2025 với thiết kế panoramic và hệ thống tản nhiệt hoàn hảo",
  ...
  const hotProducts = [
    { name: "RTX 5090", specs: "32GB GDDR7 - Blackwell", price: "65M₫", hot: true },
    { name: "Core Ultra 9 285K", specs: "24 Cores, 5.7GHz - Arrow Lake", price: "15.5M₫", hot: true },
    { name: "DDR5-6400 32GB", specs: "Gaming RAM - High Speed", price: "3.5M₫", hot: false },
    { name: "HAVN HS 420", specs: "Premium Gaming Case", price: "4.5M₫", hot: true },
    { name: "Z890 Motherboard", specs: "LGA 1851 - Latest Socket", price: "8M₫", hot: false }
  ];
