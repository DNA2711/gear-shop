          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 lg:gap-6">
            {visibleBrands.map((brand, index) => (
              ...
              >
                ...
                {/* Brand Card */}
                <div className="relative bg-gradient-to-br from-white/95 to-gray-100/95 backdrop-blur-sm p-6 lg:p-8 rounded-2xl border border-gray-300/50 group-hover:border-blue-400/50 transition-all duration-500 group-hover:transform group-hover:scale-105 h-32 flex items-center justify-center shadow-lg hover:shadow-xl">
                  {/* Shine Effect */}
