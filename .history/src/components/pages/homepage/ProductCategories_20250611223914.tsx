      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-slate-300 text-base sm:text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            Khám phá các danh mục linh kiện máy tính gaming và workstation hàng đầu
          </p>
        </div>
                ...
                >
                  ...
                  <div className="relative z-10 h-full flex flex-col justify-between">
                    ...
                    <div className="flex-1">
                      <h3 className="text-sm sm:text-base font-bold mb-2 leading-tight">{category.name}</h3>
        ...
        <div className="mt-12 sm:mt-16">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 bg-slate-800/30 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 border border-slate-700/50">
            <div className="text-center group">
              ...
              <div className="text-slate-300 font-medium text-xs sm:text-sm">Sản phẩm có sẵn</div>
            </div>
            ...
            <div className="text-center group">
              ...
              <div className="text-slate-300 font-medium text-xs sm:text-sm">Hỗ trợ kỹ thuật</div>
            </div>
            ...
            <div className="text-center group">
              ...
              <div className="text-slate-300 font-medium text-xs sm:text-sm">Vận chuyển nhanh</div>
            </div>
