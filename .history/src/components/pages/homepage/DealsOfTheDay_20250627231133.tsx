...
export default function DealsOfTheDay() {
  ...
  return (
    <section className="relative overflow-hidden scroll-section">
      ...
      <div className="absolute top-0 left-0 w-full h-8 bg-gradient-to-b from-red-500/10 via-red-400/5 to-transparent"></div>
      ...
      <div className="absolute bottom-0 left-0 w-full h-8 bg-gradient-to-t from-red-500/10 via-red-400/5 to-transparent"></div>
    </section>
  );
}
