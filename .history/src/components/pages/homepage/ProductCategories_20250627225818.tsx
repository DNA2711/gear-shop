      ...
      <section className="py-20 relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-black bg-gradient-to-r from-white via-blue-100 to-white bg-clip-text text-transparent mb-4">
              Danh Mục Sản Phẩm
            </h2>
          </div>
  ...
  return (
    <section className="py-20 relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-indigo-500/5 to-violet-500/5 rounded-full blur-3xl animate-pulse delay-2000"></div>
        
        {/* Grid Pattern */}
        <div className="absolute inset-0 bg-[linear-gradient(rgba(99,102,241,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(99,102,241,0.03)_1px,transparent_1px)] bg-[size:3rem_3rem]"></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          {/* Main Title */}
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-black bg-gradient-to-r from-white via-blue-100 to-white bg-clip-text text-transparent mb-6 leading-tight">
            Danh Mục
            <br />
          ...
          <p className="text-slate-300 text-xl lg:text-2xl max-w-3xl mx-auto leading-relaxed mb-8">
            Khám phá <span className="text-indigo-400 font-semibold">hàng nghìn sản phẩm</span> chất lượng cao được 
            <span className="text-purple-400 font-semibold"> phân loại chi tiết</span> để bạn dễ dàng tìm kiếm
          </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {categories.map((category, index) => (
            ...
            >
              <div className="relative overflow-hidden rounded-2xl bg-slate-800/60 backdrop-blur-sm shadow-xl border border-slate-700/50 hover:shadow-2xl hover:border-slate-600/50 transition-all duration-500 transform hover:-translate-y-3 hover:scale-105">
                {/* Gradient Background */}
