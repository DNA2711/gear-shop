...
const techNews: NewsItem[] = [
  ...
  },
  {
    ...
    excerpt: "Phiên bản mới nhất của Raspberry Pi mang đến hiệu năng vượt trội...",
    image: "https://images.unsplash.com/photo-1562808893-1ba5d5bb8b01?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    date: "2024-01-12",
    category: "Hardware",
    readTime: 3,
  },
