...
import { Calendar, Clock, BookOpen, TrendingUp, Star, ArrowRight } from "lucide-react";
...
const techNews: NewsItem[] = [
  {
    ...
    excerpt: "NVIDIA công bố RTX 5090 với kiến trúc Blackwell mới, hiệu năng vượt trội gấp 2 lần RTX 4090...",
  ...
  },
  {
    ...
    excerpt: "Bộ vi xử lý flagship mới với 24 cores và hiệu suất năng lượng cải thiện đáng kể...",
  ...
  },
  {
    ...
    excerpt: "Công nghệ RAM thế hệ mới với băng thông cực khủng cho gaming và content creation...",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-300 text-xl max-w-2xl mx-auto leading-relaxed">
            Cập nhật những tin tức mới nhất và đánh giá chi tiết về công nghệ phần cứng
          </p>
        </div>
            ...
            >
              ...
              <div className="relative overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4">
                  <span className={`px-3 py-1 rounded-full text-xs font-semibold backdrop-blur-sm border ${getCategoryColor(item.category)}`}>
                    {item.category}
                  </span>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center text-sm text-slate-400 mb-4">
                  ...
                  <time dateTime={item.date} className="mr-3">{formatDate(item.date)}</time>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="group bg-slate-800/30 backdrop-blur-sm rounded-2xl p-8 text-center border border-slate-700/50 hover:border-blue-500/50 transition-all duration-300 hover:scale-105">
            <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center text-3xl mb-4 mx-auto group-hover:scale-110 transition-transform duration-300">
              📚
            </div>
            <h3 className="text-xl font-bold text-white mb-3">Hướng Dẫn</h3>
            <p className="text-slate-300 mb-4">50+ tutorial chi tiết</p>
            <div className="text-blue-400 font-semibold">Build PC, Overclock, Setup</div>
          </div>

          <div className="group bg-slate-800/30 backdrop-blur-sm rounded-2xl p-8 text-center border border-slate-700/50 hover:border-green-500/50 transition-all duration-300 hover:scale-105">
            <div className="w-16 h-16 bg-gradient-to-r from-green-500 to-green-600 rounded-2xl flex items-center justify-center text-3xl mb-4 mx-auto group-hover:scale-110 transition-transform duration-300">
              🔧
            </div>
            <h3 className="text-xl font-bold text-white mb-3">Reviews</h3>
            <p className="text-slate-300 mb-4">30+ đánh giá chi tiết</p>
            <div className="text-green-400 font-semibold">GPU, CPU, Gaming Gear</div>
          </div>

          <div className="group bg-slate-800/30 backdrop-blur-sm rounded-2xl p-8 text-center border border-slate-700/50 hover:border-purple-500/50 transition-all duration-300 hover:scale-105">
            <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-purple-600 rounded-2xl flex items-center justify-center text-3xl mb-4 mx-auto group-hover:scale-110 transition-transform duration-300">
              💡
            </div>
            <h3 className="text-xl font-bold text-white mb-3">Tips & Tricks</h3>
            <p className="text-slate-300 mb-4">Kinh nghiệm từ pro</p>
            <div className="text-purple-400 font-semibold">Performance, Optimization</div>
          </div>

          <div className="group bg-slate-800/30 backdrop-blur-sm rounded-2xl p-8 text-center border border-slate-700/50 hover:border-orange-500/50 transition-all duration-300 hover:scale-105">
            <div className="w-16 h-16 bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl flex items-center justify-center text-3xl mb-4 mx-auto group-hover:scale-110 transition-transform duration-300">
              🎥
            </div>
            <h3 className="text-xl font-bold text-white mb-3">Video</h3>
            <p className="text-slate-300 mb-4">Hướng dẫn video</p>
            <div className="text-orange-400 font-semibold">YouTube, Live Stream</div>
          </div>
        </div>
