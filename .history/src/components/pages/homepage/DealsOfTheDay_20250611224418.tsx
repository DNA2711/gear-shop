    ...
    <section className="py-12 relative overflow-hidden scroll-section">
      ...
      <div className="container mx-auto px-4 relative z-10 max-w-7xl">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center bg-gradient-to-r from-red-600 to-orange-600 text-white px-4 py-2 rounded-full text-xs sm:text-sm font-semibold mb-4 shadow-lg backdrop-blur-sm animate-pulse">
            <Flame className="w-3 h-3 sm:w-4 sm:h-4 mr-2" />
            FLASH SALE - DEAL HOT
          </div>

          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-red-400 via-orange-400 to-yellow-400 bg-clip-text text-transparent mb-4 leading-tight">
            Flash Sale Siêu Hot
          </h2>
                  ...
                  <div className="flex flex-col lg:flex-row">
                    ...
                    <div className="lg:w-1/2 relative overflow-hidden">
                      <img
                        src={deal.image}
                        alt={deal.name}
                        className="w-full h-48 lg:h-52 xl:h-56 object-cover object-center group-hover:scale-110 transition-transform duration-700"
                      />
