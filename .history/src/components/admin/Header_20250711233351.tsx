        ...
        <div className="flex items-center space-x-3 sm:space-x-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-32 sm:w-64 lg:w-80 pl-10 pr-4 py-2 bg-white/10 border border-white/20 text-white placeholder-gray-300 rounded-lg backdrop-blur-sm focus:bg-white/20 focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-400/50 transition-all duration-200 text-sm"
            />
          </div>
        </div>
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="flex items-center space-x-1 sm:space-x-2 p-1.5 sm:p-2 rounded-lg hover:bg-white/10 transition-all duration-200 group">
                  <div className="h-7 w-7 sm:h-8 sm:w-8 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full flex items-center justify-center">
                    <User className="h-4 w-4 sm:h-5 sm:w-5 text-gray-900" />
                  </div>
                  <ChevronDown className="hidden sm:block h-4 w-4 text-gray-300 group-hover:text-white transition-colors" />
                </button>
              </DropdownMenuTrigger>
