  ...
  if (loading) {
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="relative overflow-hidden rounded-2xl bg-white p-6 shadow-lg border border-gray-100 animate-pulse">
    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        <div className="col-span-full text-center py-12 text-gray-500 bg-white rounded-2xl shadow-lg">
          <div className="text-lg font-medium">Không thể tải dữ liệu thống kê</div>
            ...
            <div className="mt-4 flex items-center text-xs text-gray-500">
              <div className={`flex items-center ${
                ...
                <span className="font-medium">
                  {stat.changeType === "neutral" ? "Ổn định" : "So với tháng trước"}
                </span>
              </div>
            </div>
          </div>
