...
function GeneralToast({ toast, onClose }: { toast: Toast; onClose: () => void }) {
  React.useEffect(() => {
  ...
  return (
    <div 
      className={`fixed top-4 right-4 z-50 px-6 py-4 rounded-lg shadow-lg flex items-center gap-3 min-w-[300px] animate-in slide-in-from-right duration-300 ${getToastStyles()}`}
    >
