...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log("✅ DB connection test:", testConn);

    // Step 1: Test basic count with debug
    ...
    // Also test direct query without parameters
    const [directCount] = await db.query("SELECT COUNT(*) as total FROM notifications WHERE user_id = 8");
    console.log("📊 Direct query result:", directCount);
