...
export async function GET(
  ...
  try {
    ...
    const specification = await ProductService.getProductSpecificationById(
      specId
    );
    ...
    if (process.env.NODE_ENV === "development") {
      ...
      console.error("Error fetching specification:", (error as any).message);
    }
    return NextResponse.json(
...
export async function PUT(
  ...
  try {
    ...
    if (process.env.NODE_ENV === "development") {
      ...
      console.error("Error updating specification:", (error as any).message);
    }
    return NextResponse.json(
...
export async function DELETE(
  ...
  try {
    ...
    if (process.env.NODE_ENV === "development") {
      ...
      console.error("Error deleting specification:", (error as any).message);
    }
    return NextResponse.json(
