    ...
    if (status === "paid") {
      try {
        ...
        if (orderDetails) {
          ...
          console.log(`Payment simulated successfully! Notifications created for order ${orderId}`);
        }
      } catch (notificationError) {
        console.error("Error creating notifications after simulated payment:", notificationError);
      }
    }
