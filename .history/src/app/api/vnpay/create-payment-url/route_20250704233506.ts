...
export async function POST(request: NextRequest) {
  try {
    ...
    // Kiểm tra giới hạn số tiền theo yêu cầu của VNPAY (số tiền gốc, chưa nhân 100)
    ...
    console.log("Original amount:", amountNum, "VNPay amount:", vnpAmount);
    ...
    const vnpParams = {
      ...
      vnp_OrderType: "other",
      vnp_Amount: vnpAmount, // Số tiền đã được nhân 100
