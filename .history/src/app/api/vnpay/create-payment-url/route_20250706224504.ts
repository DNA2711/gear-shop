...
export async function POST(request: NextRequest) {
  try {
    ...
    // Trong development mode với DEMO config, sử dụng mock VNPay
    if (IS_DEVELOPMENT && IS_DEMO_MODE) {
      ...
      console.log("Using mock VNPay for development (DEMO mode):", mockPaymentUrl);
    ...
    // Sử dụng VNPay thật (sandbox hoặc production)
