...
export async function GET(
  ...
  try {
    ...
    if (process.env.NODE_ENV === "development") {
      ...
      console.error("Error fetching product:", (error as any).message);
    }
    return NextResponse.json(
      {
        success: false,
...
export async function PUT(
  ...
  try {
    ...
    if (process.env.NODE_ENV === "development") {
      ...
      console.error("Error updating product:", (error as any).message);
    }
    return NextResponse.json(
      {
        success: false,
...
export async function DELETE(
  ...
  try {
    ...
    if (process.env.NODE_ENV === "development") {
      ...
      console.error("Error deleting product:", (error as any).message);
    }
    return NextResponse.json(
      {
        success: false,
