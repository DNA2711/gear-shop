...
import { Bell, Filter, CheckCheck, RotateCcw, Calendar, Eye, Trash2 } from "lucide-react";
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-3">
              ...
              >
                <RotateCcw className={`w-4 h-4 inline mr-2 ${loading ? "animate-spin" : ""}`} />
                Làm mới
              </button>
            </div>
          ...
          {loading && notifications.length === 0 ? (
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4 text-sm text-gray-500">
                          ...
                          <span>•</span>
                          <span>{notification.category.replace(/_/g, " ")}</span>
                        </div>
            ...
            <div className="text-center py-12 bg-white rounded-lg shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">
                {filter.unreadOnly ? "Không có thông báo chưa đọc" : "Chưa có thông báo nào"}
              </h3>
