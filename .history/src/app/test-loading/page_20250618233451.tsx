      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gray-100 p-6 rounded-lg mt-8">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700">
            ...
            <li>
              <strong>🚀 Instant Loading:</strong> Click các button với icon
              rocket để thấy loading hiện NGAY LẬP TỨC
            </li>
            <li>
              <strong>🐌 No Loading:</strong> Click button màu xám để so sánh -
              không có loading
            </li>
            <li>
              <strong>Admin Sidebar:</strong> Chuyển giữa các tab admin sidebar
              để thấy instant loading
            </li>
            <li>
          ...
          <div className="mt-4 p-4 bg-blue-50 rounded-lg">
            ...
            <p className="text-blue-700">
              <strong>Instant Loading</strong> hiển thị loading overlay NGAY khi
              bạn click, không cần chờ Next.js detect route change. Điều này tạo
              cảm giác phản hồi nhanh hơn!
            </p>
          </div>
        </div>
      </div>
