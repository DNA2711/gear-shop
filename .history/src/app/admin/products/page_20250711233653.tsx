    ...
    <div className="space-y-4 sm:space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-2">
          <button
            onClick={fetchProducts}
            className="bg-gray-100 text-gray-700 px-3 py-2 rounded-lg hover:bg-gray-200 flex items-center justify-center space-x-2 text-sm sm:text-base"
          >
            <RefreshCw className="h-4 w-4" />
            <span>Làm mới</span>
          </button>
          <button
            onClick={handleAdd}
            className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 flex items-center justify-center space-x-2 text-sm sm:text-base"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-4 sm:p-6">
          <div className="flex items-center justify-between">
            ...
            <Eye className="h-8 w-8 sm:h-12 sm:w-12 text-green-600" />
          </div>
        </div>
        ...
        <div className="lg:hidden">
          {products.length === 0 ? (
            <div className="p-8 text-center text-gray-500">
              ...
              <div className="text-sm">Hãy tạo sản phẩm đầu tiên!</div>
            </div>
          ) : (
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between space-y-3 sm:space-y-0">
              ...
              <div className="flex items-center space-x-1 sm:space-x-2">
                <button
                  ...
                  disabled={page === 1}
                  className="px-2 sm:px-3 py-1 sm:py-2 text-sm border border-gray-300 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-50"
                >
                  Trước
                </button>
                  ...
                  {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                    ...
                    return (
                      <button
                        ...
                        className={`px-2 sm:px-3 py-1 sm:py-2 text-sm border rounded-lg ${
                          page === pageNum
