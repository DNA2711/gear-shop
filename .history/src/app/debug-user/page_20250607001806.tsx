        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <p><strong>user?.full_name:</strong> {user?.full_name || 'undefined'}</p>
              <p><strong>user?.fullName:</strong> {user?.fullName || 'undefined'}</p>
              <p><strong>user?.username:</strong> {user?.username || 'undefined'}</p>
              <p><strong>user?.role:</strong> {user?.role || 'undefined'}</p>
            </div>
            <div>
              <p><strong>getUserDisplayName(user):</strong> {getUserDisplayName(user)}</p>
              <p><strong>Direct full_name access:</strong> {user?.full_name || 'N/A'}</p>
            </div>
          </div>
        </div>
