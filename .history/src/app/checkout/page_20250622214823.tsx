    ...
    if (savedSelectedItems) {
      try {
        ...
        if (parsedItems && parsedItems.length > 0) {
          ...
          console.warn("No valid selected items found, redirecting to cart");
          router.push("/cart");
        }
      } catch (error) {
      ...
      // If no selected items, check if user has items in cart
      // If cart is empty, redirect to products, otherwise to cart
