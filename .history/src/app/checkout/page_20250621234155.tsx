          ...
          <div className="max-w-6xl mx-auto">
            <div className="glass-card-prominent rounded-xl p-8">
              <div className="text-center mb-8">
                <h1 className="text-3xl font-bold text-on-glass mb-2">
                  Thanh toán
                </h1>
                <p className="text-secondary-glass">
                    ...
                    {cart.items.map((item) => (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <h3 className="text-on-glass font-medium">
                            {item.product_name}
                          </h3>
                          <p className="text-secondary-glass text-sm">
