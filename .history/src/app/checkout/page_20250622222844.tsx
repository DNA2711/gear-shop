...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    ...
    console.log("Checkout useEffect - checking for selectedCartItems");
    const savedSelectedItems = localStorage.getItem("selectedCartItems");
    console.log("savedSelectedItems from localStorage:", savedSelectedItems);
    ...
    if (savedSelectedItems) {
      try {
        ...
        setDataLoaded(true);
        console.log(
          "Successfully loaded selected items, removed from localStorage"
        );
      } catch (error) {
        console.error("Error parsing selected items:", error);
        // If no selected items or error, show message but don't redirect
        console.log("Error parsing, showing error message");
        setDataLoaded(true);
        alert(
          "Có lỗi xảy ra khi tải dữ liệu. Vui lòng quay lại giỏ hàng và thử lại."
        );
      }
    } else {
      // If no selected items, show message but don't redirect
