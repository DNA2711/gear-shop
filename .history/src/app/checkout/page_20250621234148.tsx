          ...
          <div className="max-w-6xl mx-auto">
            <div className="glass-card-prominent rounded-xl p-8">
              <div className="text-center mb-8">
                <h1 className="text-3xl font-bold text-on-glass mb-2">Thanh toán</h1>
                <p className="text-secondary-glass">Hoàn tất đơn hàng của bạn</p>
              </div>

              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {/* Order Summary */}
                <div className="glass-card rounded-lg p-6">
                  <h2 className="text-xl font-semibold text-on-glass mb-6">
                    Đơn hàng của bạn
                  </h2>
                  ...
                  <div className="space-y-4 mb-6">
                    {cart.items.map((item) => (
                      ...
                      >
                        <img
                          src={item.primary_image || "/images/default-product.jpg"}
                          alt={item.product_name}
                          className="w-16 h-16 object-cover rounded-lg"
                        />
                        <div className="flex-1">
                          <h3 className="text-on-glass font-medium">{item.product_name}</h3>
                          <p className="text-secondary-glass text-sm">Số lượng: {item.quantity}</p>
                        </div>
                        <div className="text-right">
                          <p className="text-on-glass font-semibold">
                ...
                {/* Payment Form */}
                <div className="glass-card rounded-lg p-6">
                  <h2 className="text-xl font-semibold text-on-glass mb-4">
                    Thông tin thanh toán
                  </h2>

                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                      <label className="block text-sm font-medium text-on-glass mb-2">
                        Họ và tên
                      </label>
                      <input
                        type="text"
