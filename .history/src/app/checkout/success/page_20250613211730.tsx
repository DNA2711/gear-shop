      ...
      <div className="max-w-2xl mx-auto px-4">
        <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
          ...
          <p className="text-gray-600 mb-8">
            Cảm ơn bạn đã đặt hàng. Chúng tôi đã gửi thông tin đơn hàng đến email của bạn.
            Vui lòng kiểm tra email để biết thêm chi tiết về đơn hàng và hướng dẫn thanh toán.
          </p>
          ...
          <div className="mt-8 pt-8 border-t border-gray-200">
            ...
            <div className="bg-blue-50 rounded-xl p-4 text-left">
              <p className="text-sm text-blue-900">
                ...
                <strong>Chủ tài khoản:</strong> CÔNG TY TNHH GEAR SHOP<br />
                <strong>Chi nhánh:</strong> Hồ Chí Minh<br />
                <strong>Nội dung chuyển khoản:</strong> [Mã đơn hàng của bạn]
              </p>
            </div>
            <p className="text-sm text-gray-600 mt-4">
              Vui lòng chuyển khoản trong vòng 24 giờ để đảm bảo đơn hàng được xử lý nhanh chóng.
            </p>
          </div>
        </div>
      </div>
