...
import { ArrowLeft, CreditCard, Building2, User, Phone, Mail, MapPin } from "lucide-react";
...
export default function CheckoutPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // TODO: Implement actual order creation and payment processing
              ...
              <div className="space-y-4">
                ...
                <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h3 className="font-semibold text-blue-900">Chuyển khoản ngân hàng</h3>
                      <p className="text-sm text-blue-700 mt-1">
                        Ngân hàng: Vietcombank<br />
                        Số tài khoản: 1234567890<br />
                        Chủ tài khoản: CÔNG TY TNHH GEAR SHOP<br />
