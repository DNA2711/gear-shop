...
export default function CheckoutPage() {
  ...
  const handlePaymentSuccess = async () => {
    try {
      console.log(
        "[CheckoutPage] handlePaymentSuccess called! Payment success - updating cart and showing success modal..."
      );

      console.log("[CheckoutPage] Ordered items to remove:", orderedItems);

      // Remove only ordered items from cart (not everything)
      if (orderedItems.length > 0) {
        console.log("[CheckoutPage] Removing ordered items from cart...");
        await removeOrderedItems(orderedItems);
        console.log("[CheckoutPage] Cart updated successfully");
      }

      // Hide QR code and show success modal
      console.log("[CheckoutPage] Hiding QR code and showing success modal...");
      setShowQRCode(false);
      setShowSuccessModal(true);
      console.log("[CheckoutPage] Success modal should be visible now");
    } catch (error) {
