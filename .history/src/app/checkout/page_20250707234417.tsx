                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 transition-colors ${
                          showPhoneError ? "border-red-300 focus:ring-red-500 bg-red-50" : "border-gray-300 focus:ring-blue-500"
                        }`}
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 h-fit">
              ...
              <div className="mt-6 space-y-3">
                <button
                  ...
                  className={`group relative w-full overflow-hidden rounded-2xl transition-all duration-500 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-none ${
                    !isAmountValid
