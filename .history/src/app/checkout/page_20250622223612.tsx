...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    ...
    console.log("🔍 savedSelectedItems length:", savedSelectedItems ? savedSelectedItems.length : 0);
    ...
    if (savedSelectedItems) {
      ...
      alert("Không tìm thấy sản phẩm được chọn. Vui lòng quay lại giỏ hàng và chọn sản phẩm.");
    }
  }, [router, itemsLoaded]);
