  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent) => {
      ...
      try {
        ...
        console.log(
          "🔍 responseData.success type:",
          typeof responseData.success
        );
        console.log("🔍 responseData.success value:", responseData.success);
        ...
        if (isSuccess) {
          console.log("🎉 Success path - setting submitted");
          setIsSubmitted(true);
          showToast(
            responseData.message || "Email đã được gửi thành công",
            "success"
          );

          // Development mode debug
          if (responseData.resetUrl) {
            console.log("🔗 Reset URL:", responseData.resetUrl);
            showToast("Development Mode: Check console for reset link", "info");
          }
        } else {
          console.log("❌ Error path - showing error");
          showToast(
