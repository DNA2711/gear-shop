...
export default function VNPayMockCheckout() {
    ...
    if (selectedMethod === "ATM") {
      ...
      if (!cardHolder || !validateCardHolder(cardHolder)) {
        newErrors.cardHolder =
          "Tên chủ thẻ phải có ít nhất 2 ký tự, chỉ chứa chữ cái";
      }
  ...
  const handlePayment = async () => {
    ...
    try {
      // Simulate processing time - shorter for better UX
      ...
      setErrors({ otp: "Có lỗi xảy ra, vui lòng thử lại" });
    }
  };
                ...
                {currentStep === 1 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                      ...
                      >
                        <div className="text-center">
                          ...
                          <div
                            className={`w-4 h-4 rounded-full border-2 mx-auto mt-2 ${
                              selectedMethod === "ATM"
                            ...
                            <div className="relative">
                              <input
                                ...
                                onChange={(e) => {
                                  ...
                                  if (errors.atmCardNumber)
                                    setErrors({
                                      ...errors,
                                      atmCardNumber: undefined,
                                    });
                                }}
                            ...
                            <div className="relative">
                              <input
                                ...
                                onChange={(e) => {
                                  ...
                                  if (errors.atmPassword)
                                    setErrors({
                                      ...errors,
                                      atmPassword: undefined,
                                    });
                                }}
                          ...
                          <div>
                            ...
                            <div className="relative">
                              ...
                              <div className="absolute right-3 top-3">
                                {cardNumber && (
                                  <div
                                    className={`w-8 h-6 rounded text-white text-xs flex items-center justify-center font-bold ${
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-600 mb-8">
                      Mã OTP đã được gửi đến số điện thoại đăng ký với thẻ của
                      bạn
                    </p>
                      ...
                      {process.env.NODE_ENV === "development" && (
                        <div className="mt-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                          <p className="text-sm text-gray-600 mb-3 text-center">
                            Development Debug (Chỉ hiện thị trong dev)
                          </p>
                          <div className="flex space-x-2">
                            ...
                            <button
                              ...
                              disabled={processing}
                              className="flex-1 bg-red-600 text-white py-2 px-4 rounded text-sm hover:bg-red-700 disabled:opacity-50"
                            >
                              Simulate Failed
                            </button>
                          </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Thông tin được bảo vệ tuyệt đối
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
