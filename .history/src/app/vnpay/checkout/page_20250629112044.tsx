  ...
  const handlePayment = async (success: boolean) => {
    ...
    try {
      ...
      if (success) {
        ...
        router.push(`/checkout/success?orderId=${orderId}&from=vnpay&status=success`);
      } else {
        // Redirect to failed page
        router.push(`/checkout/success?orderId=${orderId}&from=vnpay&status=failed`);
      }
    } catch (error) {
        ...
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-800">VNPay Gateway</h1>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-3xl font-bold">{amount && formatAmount(amount)} VNĐ</p>
              </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <p className="font-semibold text-gray-800">Thẻ ATM nội địa</p>
                      <p className="text-sm text-gray-600">Vietcombank, Techcombank, BIDV, ACB...</p>
                    </div>
                  </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <p className="font-semibold text-gray-800">Ví điện tử QR</p>
                      <p className="text-sm text-gray-600">VNPay QR, ZaloPay, MomoPay...</p>
                    </div>
                  </div>
                  <div className={`w-5 h-5 rounded-full border-2 ${
                    selectedMethod === "QR" 
