              ...
              <div>
                ...
                >
                  ...
                  <button
                    ...
                    className={`group relative p-3 rounded-xl border-2 transition-all duration-300 hover:scale-105 flex-shrink-0 w-20 ${
                      !selectedBrand
                  ...
                  >
                    <div className="flex flex-col items-center justify-center h-12">
                      <div
                        className={`text-lg mb-1 transition-transform group-hover:scale-110 ${
                        ...
                        <div className="flex flex-col items-center justify-center h-12">
                          {brand.logo_code ? (
                            <img
                              ...
                              className="w-full h-6 object-contain transition-transform group-hover:scale-110"
                              onError={(e) => {
                          ...
                          <div
                            className={`flex flex-col items-center justify-center h-6 ${
                  ...
                  {brands.length > 8 && (
                    <button
                      ...
                      className="group relative p-3 rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 hover:bg-gray-100 transition-all duration-300 hover:scale-105 flex-shrink-0 w-20"
                      title="Xem thêm thương hiệu"
                    >
                      <div className="flex flex-col items-center justify-center h-12">
                        <div className="text-lg mb-1 text-gray-500 transition-transform group-hover:scale-110">
                          {showAllBrands ? "−" : "+"}
                        </div>
                        <span className="text-xs font-medium text-gray-600">
                          {showAllBrands ? "Thu gọn" : `${brands.length - 8}`}
                        </span>
                      </div>
                    </button>
                  )}
