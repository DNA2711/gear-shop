...
export default function ProductsPage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.log("URL Parameters:", { categoryParam, brandParam, priceParam, searchParam });

      if (categoryParam) {
        console.log("📝 Setting selectedCategory from URL:", categoryParam);
        setSelectedCategory(categoryParam);
      } else {
        console.log("📝 No categoryParam in URL, selectedCategory will be null");
      }
      if (brandParam) {
  ...
  const fetchProducts = async (
    ...
    try {
      ...
      if (categoryId) {
        console.log("Adding category_id to params:", categoryId);
      ...
      console.log("🔍 API Response:", {
        ...
        products: result.data?.slice(0, 3).map(p => ({ id: p.product_id, name: p.product_name, category_name: p.category_name }))
      });
  ...
  useEffect(() => {
    ...
    console.log("Products useEffect triggered with selectedCategory:", selectedCategory);
    setPage(1);
                ...
                <div className="grid grid-cols-7 gap-2">
                  ...
                  >
                    <div className="flex flex-col items-center justify-center h-10">
                      <div
                        className={`text-base mb-1 transition-transform group-hover:scale-110 ${
                      ...
                      <div className="flex flex-col items-center justify-center h-10">
                        {brand.logo_code ? (
                          <img
                            ...
                            className="w-full h-5 object-contain transition-transform group-hover:scale-110"
                            onError={(e) => {
                  ...
                  {brands.length > 7 && (
                    ...
                    >
                      <div className="flex flex-col items-center justify-center h-10">
                        <div className="text-base mb-1 text-gray-500 transition-transform group-hover:scale-110">
                          {showAllBrands ? "−" : "+"}
                        </div>
