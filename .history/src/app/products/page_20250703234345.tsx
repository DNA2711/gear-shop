...
export default function ProductsPage() {
  ...
  const getBrandsToShow = () => {
    ...
    // Mobile (3 cols): 2 brands + "All" button = 3 total
    // Tablet (4 cols): 3 brands + "All" button = 4 total
    // Desktop (5-6 cols): 4-5 brands + "All" button = 5-6 total
    return 5; // This ensures only one row on all screen sizes
  };
