                ...
                <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 xl:grid-cols-10 gap-4">
                  ...
                  >
                    <div className="flex flex-col items-center justify-center h-16">
                      <div className={`text-2xl mb-1 transition-transform group-hover:scale-110 ${!selectedBrand ? 'text-blue-600' : 'text-gray-600'}`}>
                        🏢
                      </div>
                      <span className={`text-xs font-medium ${!selectedBrand ? 'text-blue-700' : 'text-gray-600'}`}>
                        Tất cả
                      </span>
                    </div>
                    {!selectedBrand && (
                  ...
                  {brands.slice(0, 19).map((brand) => (
                    ...
                    >
                      <div className="flex flex-col items-center justify-center h-16">
                        ...
                        >
                          <span className={`text-xl font-bold transition-transform group-hover:scale-110 ${
                            selectedBrand === brand.brand_id.toString() ? 'text-blue-600' : 'text-gray-600'
                          }`}>
                            {brand.brand_name.charAt(0)}
                          </span>
                        </div>
                        <span className={`text-xs font-medium mt-2 truncate block w-full text-center ${
                          selectedBrand === brand.brand_id.toString() ? 'text-blue-700' : 'text-gray-600'
                        }`}>
                          {brand.brand_name}
                        </span>
                      </div>
