                ...
                <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                  ...
                  {brands.length > 7 && (
                    <button
                      ...
                      className="group relative p-3 rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 hover:bg-gray-100 transition-all duration-300 hover:scale-105"
                      title="Xem thêm thương hiệu"
                    >
                      <div className="flex flex-col items-center justify-center h-14">
                        <div className="text-xl mb-1 text-gray-500 transition-transform group-hover:scale-110">
                          {showAllBrands ? "−" : "+"}
                        </div>
                        <span className="text-xs font-medium text-gray-600">
                          {showAllBrands
                            ? "Thu gọn"
                            : `+${Math.min(brands.length - 7, 8)} khác`}
                        </span>
                      </div>
                    </button>
                  )}
