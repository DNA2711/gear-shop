              ...
              {loading ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {[...Array(8)].map((_, index) => (
                    <div
                      key={index}
                      className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-white/10 animate-pulse"
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {products.map((product) => (
                    <div
                      ...
                      className="bg-white/5 backdrop-blur-sm rounded-lg overflow-hidden border border-white/10 hover:border-white/30 transition-all duration-300 hover:scale-105"
                    >
                ...
                {products.map((product) => (
                  ...
                  >
                    <div className="aspect-w-16 aspect-h-9">
                      <img
                        src={
                          product.primary_image || "/images/default-product.jpg"
                        }
                        alt={product.product_name}
                        className="w-full h-48 object-cover"
                      />
