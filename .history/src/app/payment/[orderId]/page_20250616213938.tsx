    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600">Đơn hàng #{orderId} không tồn tại hoặc đã bị xóa</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-green-600 mb-2">Đã thanh toán</h1>
          <p className="text-gray-600">Đơn hàng #{orderId} đã được thanh toán thành công</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-md mx-auto bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500">
            Đây là trang thanh toán demo. Trong thực tế sẽ tích hợp với VNPay, MoMo, v.v.
          </p>
        </div>
      </div>
    </div>
