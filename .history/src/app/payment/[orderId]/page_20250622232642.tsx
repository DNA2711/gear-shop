        ...
        const updateOrderStatus = async () => {
          try {
            ...
            if (token) {
              ...
              console.log(
                "Available keys in localStorage:",
            ...
            const response = await fetch(`/api/orders/${orderIdParam}/status`, {
              method: "PUT",
              headers: {
            ...
            if (response.ok) {
              ...
              console.log(
                `Order ${orderIdParam} status updated to paid successfully`
              );
            } else {
              let errorData;
              try {
              ...
              console.error(
                "Failed to update order status to paid. Error:",
                errorData
              );
              console.error(
                "Response status:",
