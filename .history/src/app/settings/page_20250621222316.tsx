...
export default function SettingsPage() {
  ...
  const handleExportData = () => {
    ...
    link.href = url;
    link.download = `gear-hub-data-${new Date().toISOString().split('T')[0]}.json`;
    link.click();
          ...
          <div className="lg:col-span-3">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8 relative overflow-hidden">
              ...
              <div className="relative space-y-8">
                ...
                {activeTab === "notifications" && (
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      {[
                        { key: "email", label: "Thông báo email", icon: Mail, description: "Nhận thông báo qua email" },
                        { key: "push", label: "Thông báo đẩy", icon: Smartphone, description: "Thông báo trên thiết bị di động" },
                        { key: "orderUpdates", label: "Cập nhật đơn hàng", icon: Bell, description: "Thông báo về trạng thái đơn hàng" },
                        { key: "promotions", label: "Khuyến mãi", icon: Bell, description: "Thông báo về ưu đãi và khuyến mãi" },
                        { key: "newProducts", label: "Sản phẩm mới", icon: Bell, description: "Thông báo về sản phẩm mới" },
                      ].map((notif) => {
                        const Icon = notif.icon;
                        return (
                          <div key={notif.key} className="bg-gray-50/50 rounded-xl p-6">
                ...
                {activeTab === "privacy" && (
                  <div className="space-y-6">
                    <h2 className="text-2xl font-bold text-gray-900 mb-6">Cài đặt bảo mật & riêng tư</h2>
                    
                    <div className="space-y-4">
                      {[
                        { key: "profileVisible", label: "Hiển thị hồ sơ công khai", icon: Eye, description: "Cho phép người khác xem hồ sơ của bạn" },
                        { key: "showEmail", label: "Hiển thị email", icon: Mail, description: "Hiển thị email trong hồ sơ công khai" },
                        { key: "showPhone", label: "Hiển thị số điện thoại", icon: Smartphone, description: "Hiển thị số điện thoại trong hồ sơ công khai" },
                        { key: "dataCollection", label: "Thu thập dữ liệu", icon: Shield, description: "Cho phép thu thập dữ liệu để cải thiện dịch vụ" },
                      ].map((privacy) => {
                        const Icon = privacy.icon;
                        return (
                          <div key={privacy.key} className="bg-gray-50/50 rounded-xl p-6">
                            <div className="flex items-center justify-between">
                              <div className="flex items-center space-x-4">
                                ...
                                <div>
                                  <h3 className="font-semibold text-gray-900">{privacy.label}</h3>
                                  <p className="text-gray-600 text-sm">{privacy.description}</p>
                                </div>
                              </div>
                              <label className="relative inline-flex items-center cursor-pointer">
                                <input
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-gray-50/50 rounded-xl p-6">
                        ...
                        <p className="text-gray-600 mb-4">Tải xuống tất cả dữ liệu tài khoản của bạn</p>
                        <button
                      ...
                      <div className="bg-gray-50/50 rounded-xl p-6">
                        ...
                        <p className="text-gray-600 mb-4">Quản lý mật khẩu và bảo mật</p>
                        <button
                    ...
                    <div className="bg-red-50/50 border border-red-200 rounded-xl p-6">
                      ...
                      <p className="text-red-700 mb-4">Hành động này không thể hoàn tác. Vui lòng cân nhắc kỹ.</p>
                      <button
                        onClick={() => toast.error("Chức năng này đang được phát triển")}
