...
export default function OrdersPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Đơn hàng của bạn</h1>
        ...
        <div className="flex flex-wrap gap-2 mb-8">
          {[
            ...
            { key: "paid", label: "Đã thanh toán", count: validOrders.filter(o => o.status === "paid").length },
            { key: "processing", label: "Đang xử lý", count: validOrders.filter(o => o.status === "processing").length },
            { key: "shipped", label: "Đang giao hàng", count: validOrders.filter(o => o.status === "shipped").length },
            { key: "delivered", label: "Đã giao hàng", count: validOrders.filter(o => o.status === "delivered").length },
            { key: "cancelled", label: "Đã hủy", count: validOrders.filter(o => o.status === "cancelled").length },
          ].map((filter) => (
            <button
              key={filter.key}
        ...
        {filteredOrders.length === 0 ? (
          <div className="text-center py-12 bg-white rounded-lg shadow">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">
              {statusFilter === "all" ? "Chưa có đơn hàng nào" : "Không tìm thấy đơn hàng"}
            </h3>
