...
export default function RegisterPage() {
  ...
  return (
      ...
      <div className="w-full max-w-md">
        <div className="bg-white/10 backdrop-blur-md rounded-xl shadow-2xl border border-white/20 p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-white/70">Tạo tài khoản mới tại Gear Shop</p>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-emerald-950/40">
