...
import { Eye, EyeOff, Mail, Lock, ArrowRight, Smartphone, User, Phone } from "lucide-react";
          ...
          <div className="relative z-10">
            ...
            <div className="max-w-md">
              ...
              <p className="text-green-100 text-lg leading-relaxed">
                Tạo tài khoản để trải nghiệm mua sắm công nghệ tuyệt vời với nhiều ưu đãi độc quyền.
              </p>
            </div>
          </div>
