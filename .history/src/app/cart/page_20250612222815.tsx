            ...
            <div className="xl:col-span-1">
              <div className="bg-white rounded-2xl shadow-xl p-8 sticky top-8 border-2 border-blue-100">
                ...
                <div className="text-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-gray-800 mb-2">💰 Tóm tắt đơn hàng</h2>
                  <p className="text-gray-600 text-sm">Chi tiết thanh toán của bạn</p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-4">
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <span className="text-gray-700 font-medium">Số lượng sản phẩm:</span>
                        <span className="font-bold text-blue-600">{cart.total_items}</span>
                      </div>
                  ...
                  <div className="bg-gray-50 rounded-xl p-4 text-center">
                    <div className="text-sm text-gray-600 space-y-1">
                      <p>🔒 <strong>Giao dịch được bảo mật</strong></p>
