...
export default function CartPage() {
  ...
  const handleItemSelect = (productId: number, checked: boolean) => {
    console.log("handleItemSelect called:", productId, checked);
  ...
  const calculateSelectedTotals = () => {
    console.log(
      "calculateSelectedTotals - current selectedItems:",
      selectedItems
    );
    console.log("calculateSelectedTotals - cart.items:", cart.items);
    const selectedCartItems = cart.items.filter((item) =>
      selectedItems.has(item.product_id)
    );
    console.log(
      "calculateSelectedTotals - selectedCartItems:",
      selectedCartItems
    );
    ...
    console.log("calculateSelectedTotals - totals:", {
      total_items,
      total_price,
    });
  ...
  const handleCheckout = () => {
    ...
    try {
      ...
      console.log(
        "🚀 Storing selected items in localStorage:",
        selectedCartItems
      );
      const itemsToStore = JSON.stringify(selectedCartItems);
      console.log("🚀 JSON string to store:", itemsToStore);

      localStorage.setItem("selectedCartItems", itemsToStore);

      // Verify localStorage save
      const saved = localStorage.getItem("selectedCartItems");
      console.log("🚀 Verification - saved items:", saved);
      console.log("🚀 Verification - saved items type:", typeof saved);
      console.log(
        "🚀 Verification - saved items length:",
