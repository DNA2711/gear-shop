                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                      <div className="relative">
                        ...
                        />
                        <div className="w-5 h-5 bg-white border-2 border-gray-300 rounded-md peer-checked:border-blue-600 peer-checked:bg-blue-50 transition-all duration-200 cursor-pointer flex items-center justify-center shadow-sm hover:shadow-md">
                          <svg className="w-4 h-4 text-blue-600 opacity-0 peer-checked:opacity-100 transition-opacity duration-200" fill="none" stroke="currentColor" strokeWidth="3" viewBox="0 0 24 24">
