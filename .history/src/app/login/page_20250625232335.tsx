...
function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.success && result.user) {
      ...
      // AuthContext đã set error message từ server, không cần override
      // authError sẽ chứa thông báo cụ thể từ backend như "Email này chưa được đăng ký" hoặc "Mật khẩu không đúng"
      if (authError) {
        setError(authError);
      }
    }
