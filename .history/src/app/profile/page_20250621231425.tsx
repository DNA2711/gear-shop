              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-white/10">
                    <h3 className="text-lg font-medium text-white mb-4">Thông tin cơ bản</h3>
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-white/10">
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        <label className="text-white/70 text-sm">Thành phố</label>
                        <p className="text-white font-medium">{user.city || "Chưa cập nhật"}</p>
                      </div>
                      <div>
                        <label className="text-white/70 text-sm">Mã bưu điện</label>
                        <p className="text-white font-medium">{user.postal_code || "Chưa cập nhật"}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-white/10">
                  <h3 className="text-lg font-medium text-white mb-4">Thống kê tài khoản</h3>
