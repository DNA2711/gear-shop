    ...
    <div className="min-h-screen seamless-background">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="glass-gradient rounded-xl p-8">
            <div className="flex items-center justify-between mb-8">
              <h1 className="text-3xl font-bold text-on-glass">Thông tin cá nhân</h1>
              <button
                onClick={() => router.push("/settings")}
                className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-6 py-3 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
              >
                Cài đặt
              </button>
            </div>
            ...
            {loading ? (
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-on-glass">{user?.name}</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="glass-gradient rounded-lg p-6">
                    <h3 className="text-lg font-semibold text-on-glass mb-4 flex items-center gap-2">
