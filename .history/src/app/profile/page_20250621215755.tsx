        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-8">
                ...
                <div className="group hover:bg-gradient-to-r hover:from-purple-50/50 hover:to-pink-50/50 p-4 rounded-xl transition-all duration-300">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <span
                        className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium shadow-sm ${getRoleColor(
                          user.role
                        )}`}
                      >
                        {getRoleText(user.role)}
            ...
            {showPasswordForm && (
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8 relative overflow-hidden">
                {/* Background Pattern */}
                <div className="absolute inset-0 bg-gradient-to-br from-red-600/3 via-transparent to-orange-600/3"></div>
                
                <h3 className="text-2xl font-bold bg-gradient-to-r from-red-600 to-orange-600 bg-clip-text text-transparent mb-8 relative z-10">
                ...
                <div className="space-y-6 relative z-10">
                  <div className="group">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`w-full px-4 py-3 pr-12 border-2 rounded-xl focus:outline-none focus:ring-4 focus:ring-red-500/20 transition-all duration-300 bg-white/50 backdrop-blur-sm ${
                  ...
                  <div className="flex justify-end space-x-4 pt-6">
                    ...
                    >
                      ...
                      <span className="relative z-10">{isUpdating ? "Đang đổi..." : "Đổi mật khẩu"}</span>
                    </button>
                  </div>
                </div>
              </div>
